...
- **No** reemplaza el [Proceso Interno](/docs/componentes/proceso-interno) que deriva, calcula o analiza información ya dentro del sistema: el ETL incorpora datos desde fuera, no opera sobre los que ya están adentro
