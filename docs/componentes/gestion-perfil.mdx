...
import {gestionPerfil} from '@site/src/data/tableros/gestion-perfil';
import Galeria from '@site/src/components/Galeria';
import FichaTags from '@site/src/components/FichaTags';
import {gestionPerfil as ejemplosGestionPerfil} from '@site/src/data/ejemplos/gestion-perfil';
...
<Galeria data={ejemplosGestionPerfil} />
...
<TableroDigital data={gestionPerfil} />