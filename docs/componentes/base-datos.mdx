...
import {baseDatos} from '@site/src/data/tableros/base-datos';
import Galeria from '@site/src/components/Galeria';
import FichaTags from '@site/src/components/FichaTags';
import {baseDatos as ejemplosBaseDatos} from '@site/src/data/ejemplos/base-datos';
...
<Galeria data={ejemplosBaseDatos} />
...
| Procesos Autónomos | Opcional | Tareas autónomas de mantenimiento como respaldos automáticos, replicación o indexación, cuando esas capacidades están presentes. |

</div>

## Ejemplo de Tablero Digital

<TableroDigital data={baseDatos} />