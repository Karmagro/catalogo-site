...
import {scraper} from '@site/src/data/tableros/scraper';
import Galeria from '@site/src/components/Galeria';
import FichaTags from '@site/src/components/FichaTags';
import {scraper as ejemplosScraper} from '@site/src/data/ejemplos/scraper';
...
|:--------|:-------:|:------------|
| Actualización Manual | No | El trigger manual solo dispara la extracción; la incorporación de datos al sistema ocurre de forma automática, no por escritura directa del operador. |
| Actualización Automática | Siempre | La incorporación al sistema de datos extraídos desde fuentes externas. |
